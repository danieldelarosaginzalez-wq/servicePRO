...
let NotificationsController = class NotificationsController {
    ...
    async sendDirectMessage(req, body) {
        const senderId = req.user.userId;
        const notification = await this.notificationsService.sendDirectMessage(senderId, body.recipientId, body.message);
        return { success: true, data: notification };
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], NotificationsController.prototype, "sendDirectMessage", null);
__decorate([
